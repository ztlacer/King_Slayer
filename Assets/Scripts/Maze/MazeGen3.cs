...
public class MazeGen3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        genSubZone(4, 4, 4, 25, 25, 40, -1450, -370, transXTaken2, transZTaken2, SubZones2, 2); // x, z - 200
        ...
        genMaze(takenX2, takenZ2, transXTaken2, transZTaken2, 4, 4, 4, 25, 25, 0, 0, 0, 575, -1490, -420, 40, -20, -30, 0, -50, Walls2, 2); // x, z - 200
