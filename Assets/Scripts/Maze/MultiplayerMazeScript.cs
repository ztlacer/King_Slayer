...
public class MultiplayerMazeScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            wayPoints1[i] = new GameObject();
            wayPoints1[i].transform.position = new Vector3(0, 2, 0);
        }

        wayPoints2 = new GameObject[5];
        for (int i = 0; i < 5; i++)
        {
            wayPoints2[i] = new GameObject();
            wayPoints2[i].transform.position = new Vector3(0, 2, 0);
        }

        wayPoints3 = new GameObject[5];
        for (int i = 0; i < 5; i++)
        {
            wayPoints3[i] = new GameObject();
            wayPoints3[i].transform.position = new Vector3(0, 2, 0);
        }

        wayPoints4 = new GameObject[5];
        for (int i = 0; i < 5; i++)
        {
            wayPoints4[i] = new GameObject();
            wayPoints4[i].transform.position = new Vector3(0, 2, 0);
        }

        wayPoints5 = new GameObject[5];
        for (int i = 0; i < 5; i++)
        {
            wayPoints5[i] = new GameObject();
            wayPoints5[i].transform.position = new Vector3(0, 2, 0);
        }

        wayPoints6 = new GameObject[5];
        for (int i = 0; i < 5; i++)
        {
            wayPoints6[i] = new GameObject();
            wayPoints6[i].transform.position = new Vector3(0, 2, 0);
        }

        wayPoints7 = new GameObject[5];
        for (int i = 0; i < 5; i++)
        {
            wayPoints7[i] = new GameObject();
            wayPoints7[i].transform.position = new Vector3(0, 2, 0);
        }

        wayPoints8 = new GameObject[5];
        for (int i = 0; i < 5; i++)
        {
            wayPoints8[i] = new GameObject();
            wayPoints8[i].transform.position = new Vector3(0, 2, 0);
        }

        wayPoints9 = new GameObject[5];
        for (int i = 0; i < 5; i++)
        {
            wayPoints9[i] = new GameObject();
            wayPoints9[i].transform.position = new Vector3(0, 2, 0);
        }

        wayPoints10 = new GameObject[5];
        for (int i = 0; i < 5; i++)
        {
            wayPoints10[i] = new GameObject();
            wayPoints10[i].transform.position = new Vector3(0, 2, 0);
        }
        wayPoints11 = new GameObject[5];
        for (int i = 0; i < 5; i++)
        {
            wayPoints11[i] = new GameObject();
            wayPoints11[i].transform.position = new Vector3(0, 2, 0);
        }

        wayPoints12 = new GameObject[5];
        for (int i = 0; i < 5; i++)
        {
            wayPoints12[i] = new GameObject();
            wayPoints12[i].transform.position = new Vector3(0, 2, 0);
        }
        wayPoints13 = new GameObject[5];
        for (int i = 0; i < 5; i++)
        {
            wayPoints13[i] = new GameObject();
            wayPoints13[i].transform.position = new Vector3(0, 2, 0);
        }

        wayPoints14 = new GameObject[5];
        for (int i = 0; i < 5; i++)
        {
            wayPoints14[i] = new GameObject();
            wayPoints14[i].transform.position = new Vector3(0, 2, 0);
        }
        wayPoints15 = new GameObject[5];
        for (int i = 0; i < 5; i++)
        {
            wayPoints15[i] = new GameObject();
            wayPoints15[i].transform.position = new Vector3(0, 2, 0);
        }

        wayPoints16 = new GameObject[5];
        for (int i = 0; i < 5; i++)
        {
            wayPoints16[i] = new GameObject();
            wayPoints16[i].transform.position = new Vector3(0, 2, 0);
        }
