...
public class DisplayPuzzle : MonoBehaviour
{
    ...
    public void Authenticate()
    {
        ...
        if (puzzle.database.GetItem[id0].type != ItemType.Queen || puzzle.database.GetItem[id1].type != ItemType.Bishop
            || puzzle.database.GetItem[id2].type != ItemType.Knight || puzzle.database.GetItem[id3].type != ItemType.Brook)
        {
            //return false;
        ...
        else if (puzzle.database.GetItem[id4].type != ItemType.Queen || puzzle.database.GetItem[id5].type != ItemType.Bishop
            || puzzle.database.GetItem[id6].type != ItemType.Knight || puzzle.database.GetItem[id7].type != ItemType.Brook)
        {
            //return false;
            unlockMessage.text = "Fail";
            unlockMessage.color = Color.red;
        ...
        else if (puzzle.database.GetItem[id8].type != ItemType.Queen || puzzle.database.GetItem[id9].type != ItemType.Bishop
            || puzzle.database.GetItem[id10].type != ItemType.Knight || puzzle.database.GetItem[id11].type != ItemType.Brook)
        {
            //return false;
            unlockMessage.text = "Fail";
            unlockMessage.color = Color.red;
        ...
        else if (puzzle.database.GetItem[id12].type != ItemType.Queen || puzzle.database.GetItem[id13].type != ItemType.Bishop
            || puzzle.database.GetItem[id14].type != ItemType.Knight || puzzle.database.GetItem[id15].type != ItemType.Brook)
        {
            //return false;
            unlockMessage.text = "Fail";
            unlockMessage.color = Color.red;
